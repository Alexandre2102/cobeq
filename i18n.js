(() => {
  const translations = {
    ...
    "Documenter l’avancement sans mélanger la présentation principale.": "Document progress without mixing it into the main presentation.",
    "La page d’accueil explique rapidement le projet. Cette page sert plutôt de carnet public pour montrer les nouvelles photos, les étapes franchies et les appuis confirmés au fil du développement.": "The homepage quickly explains the project. This page serves as a public journal for new photos, completed steps and confirmed support as development progresses.",
    "Publications": "Posts",
